  ...
  return (
    <div>
      ...
      <div className="w-full py-16">
        <div className="wrapper w-full flex justify-between gap-10">
          <div className="w-[50%] flex-center flex-col gap-7">
            ...
            <div className="w-full flex gap-5">
                <p className="p-bold-20 underline w-[30%]">Target Muscle: </p>
            ...
            <div className="w-full flex gap-5">
                <p className="p-bold-20 underline w-[30%]">Secondary Target Muscles: </p>
            ...
            <div className="w-full flex items-center gap-5">
                <p className="p-bold-20 underline w-[30%]">Equipments Required: </p>
            ...
            <div className="w-full flex items-center gap-5">
                <p className="p-bold-20 underline w-[30%]">Force Type: </p>
                <p className="text-[17px] font-bold uppercase text-red-600">{exercise.forceType}</p>
            </div>
            <Separator className="bg-gray-400" />
            <div className="w-full">
              {exercise?.description?.split(". ").map((item) => (
                <p className="p-regular-18"> {item}.</p>
              ))}
            </div>
          </div>
          <div className="w-[40%] flex flex-col items-center py-8">
