    ...
    <div className='w-full h-screen bg-cover bg-right text-white flex justify-center items-center' style={{backgroundImage: "url('/assets/images/about_banner.jpg')"}}>
        <div className="wrapper">
            <div className='flex flex-col gap-3 md:w-[50%]'>
                ...
                <Link href={"/about"} className='py-3 ps-7 pe-3 border-2 border-white md:border-red-700 flex-center w-fit rounded-full text-lg mt-2 gap-4 hover:bg-red-700 transition-colors duration-500 bg-red-700 md:bg-transparent'>
                  Learn More About Us
